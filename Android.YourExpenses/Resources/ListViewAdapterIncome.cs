...
{
    public class ViewHolderTwo : Java.Lang.Object
    {
    ...
    public class ListViewAdapterIncome : BaseAdapter
    {
        private Activity activity;
        private List<Income> lstExpense;

        public ListViewAdapterIncome(Activity activity, List<Income> lstExpense)
        {
